...
DATA_FILES=(
  "no-training_CoT-0-shot_OpenBookQA_llama3_main-dev:data/OpenBookQA/inference/CoT-0-shot/CoT-0-shot_main_dev.jsonl"
  "no-training_CoT-0-shot_OpenBookQA_llama3_main-test:data/OpenBookQA/inference/CoT-0-shot/CoT-0-shot_main_test.jsonl"
  "no-training_CoT-0-shot_OpenBookQA_llama3_add-dev:data/OpenBookQA/inference/CoT-0-shot/CoT-0-shot_add_dev.jsonl"
  "no-training_CoT-0-shot_OpenBookQA_llama3_add-test:data/OpenBookQA/inference/CoT-0-shot/CoT-0-shot_add_test.jsonl"
)
