...
DATA_FILES=(
  #"no-training_2-shot_OpenBookQA_llama3_main-train:data/OpenBookQA/inference/2-shot/2-shot_main_train.jsonl"
  "no-training_2-shot_OpenBookQA_llama3_main-dev:data/OpenBookQA/inference/few-shot/2-shot_main_dev.jsonl"
  "no-training_2-shot_OpenBookQA_llama3_main-test:data/OpenBookQA/inference/few-shot/2-shot_main_test.jsonl"
  #"no-training_2-shot_OpenBookQA_llama3_add-train:data/OpenBookQA/inference/2-shot/2-shot_add_train.jsonl"
  "no-training_2-shot_OpenBookQA_llama3_add-dev:data/OpenBookQA/inference/few-shot/2-shot_add_dev.jsonl"
  "no-training_2-shot_OpenBookQA_llama3_add-test:data/OpenBookQA/inference/few-shot/2-shot_add_test.jsonl"
)
