...
DATA_FILES=(
  ...
  "training_2-shot-main_OpenBookQA_llama3_main-dev:data/OpenBookQA/inference/few-shot/2-shot_main-dev.jsonl"
  "training_2-shot-main_OpenBookQA_llama3_main-test:data/OpenBookQA/inference/few-shot/2-shot_main-test.jsonl"
  #"training_0-shot_OpenBookQA_llama3_add-train:data/OpenBookQA/inference/0-shot/0-shot_add-train.jsonl"
  "training_2-shot-main_OpenBookQA_llama3_add-dev:data/OpenBookQA/inference/few-shot/2-shot_add-dev.jsonl"
  "training_2-shot-main_OpenBookQA_llama3_add-test:data/OpenBookQA/inference/few-shot/2-shot_add-test.jsonl"
)
